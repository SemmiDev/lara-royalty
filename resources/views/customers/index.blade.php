<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-between items-center">
            ...
            <button
                data-modal-target="create-new-customer-modal" data-modal-toggle="create-new-customer-modal"
            ...
            <div id="create-new-customer-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div
                            ...
                            <button type="button"
                                    ...
                                    data-modal-hide="create-new-customer-modal">
                        ...
                        <form class="p-4 md:p-5" action="{{route('customers.store', $tenant)}}" method="POST">
                            @csrf
                            <div class="space-y-4">
                                <div>
                                    <label for="name"
                                    ...
                                    <input type="text" name="name" id="name"
                                           ...
                                           placeholder="Ucup Surucup" required>
                                </div>
                                <button type="submit"
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4">
                                <div class="gap-2 items-center justify-center flex">
                                    ...
                                    <a
                                        href="{{route('customers.voucherHistory', ['customer' => $customer, 'tenant' => $tenant])}}"
                                    ...
                                    <a
                                        href="{{route('customers.transactionHistory', ['customer' => $customer, 'tenant' => $tenant])}}"
                                        class="focus:outline-none w-fit flex gap-2 items-center text-white bg-[#02AF81] hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                             stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
